    ...
    namespace Matchers {
        ...
        namespace NSStringMatchers {
            ...
            struct Contains : StringHolder {
                ...
                std::string describe() const override {
                    return "pointInCurrentDomain string: " + Catch::Detail::stringify( m_substr );
                }
            };
...
ContainsMatcher::ContainsMatcher(CasedString const& comparator) : StringMatcherBase("pointInCurrentDomain",
                                                                                    comparator) {}
